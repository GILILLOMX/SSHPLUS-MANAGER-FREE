...
wget https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUQ/SSHPLUS-MANAGER-FREE/master/Install/sshplus -O /usr/lib/sshplus > /dev/null 2>&1
clear
...
echo ""
echo -e "\033[1;31m● \033[1;33mAtivar Proxy Squid nas portas 80, 8080 3128 e 8799 \033[0m"
echo -e "\033[1;31m● \033[1;33mConfigurar OpenSSH para rodar nas portas 22 \033[0m"
...
echo ""
echo -e "\033[1;31m● \033[1;33mProxy Squid Instalado, Portas: 80, 8080, 3128 e 8799\033[0m"
echo -e "\033[1;31m● \033[1;33mOpenSSH rodando nas portas 22\033[0m"
